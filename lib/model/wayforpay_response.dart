...
WayForPayResponse wayForPayResponseFromJson(String str) => WayForPayResponse.fromJson(json.decode(str));

String wayForPayResponseToJson(WayForPayResponse data) => json.encode(data.toJson());
...
class WayForPayResponse {
  ...
  factory WayForPayResponse.fromJson(Map<String, dynamic> json) => WayForPayResponse(
